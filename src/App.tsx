    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <header className="relative min-h-screen flex items-center justify-center overflow-hidden pb-16">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto mt-8 animate-fade-in pb-12">
            <h1 className="text-2xl md:text-4xl font-bold mb-6 leading-loose tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-yellow-600 drop-shadow-lg pb-10">
